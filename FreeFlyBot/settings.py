...
CREATE_TABLE_TYPES: Final = f"""CREATE TABLE IF NOT EXISTS {TYPES_TABLE_NAME} (
    ...
    FOREIGN KEY(server_id) REFERENCES {DS_SERVERS_TABLE_NAME}(server_id));"""
...
CREATE_TABLE_ON_JOIN: Final = f"""CTRATE TABLE IF NOT EXISTS {ON_JOIN_TABLE_NAME} (
    onjoin_id INTEGER PRIMARY KEY,
...
CREATE_TABLE_ON_JOIN_ACTIONS: Final = f"""CREATE TABLE IF NOT EXISTS {ON_JOIN_ACTIONS_TABLE_NAME} (
    ...
    FOREIGN KEY(onjoin_id) REFERENCES {ON_JOIN_TABLE_NAME}(onjoin_id));"""