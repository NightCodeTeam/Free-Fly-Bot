...
- [ ] перенести логику из команды test в add_event, добавить создание класса Event и добавление его в базу данных
...
- [ ] написать парсер аргументов полученных от event_modal
